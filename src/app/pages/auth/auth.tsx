...
export function Auth() {
    ...
    return (
        <div className={styles["auth-page"]}>
            ...
            <img
                src="file:///F:\Web\Java\chatgpt\chatgpt-web\docs\images\qrcode_for_gh_921349cd1dd5_258.jpg"
                style={{ width: 250 }}
            />
            <div className={styles["auth-tips"]}>
                扫码关注公众号【即时畅聊】，
                <a
                    href="file:///F:\Web\Java\chatgpt\chatgpt-web\docs\images\qrcode_for_gh_921349cd1dd5_258.jpg"
                    target="_blank"
                >
                    回复【403】获取访问密码
                </a>
